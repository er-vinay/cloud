<?php
	...
	class CollectionController extends CI_Controller
	{
	    ...
	    public function collectionDetails($lead_id, $refrence_no = null)
	    {
            ...
            $select = 'LD.lead_id, LD.customer_id, CO.id, CO.loan_no, CO.payment_mode, CO.discount, CO.refund, CO.date_of_recived, CO.received_amount, CO.refrence_no, CO.repayment_type, CO.remarks, CO.payment_verification, CO.created_on';
