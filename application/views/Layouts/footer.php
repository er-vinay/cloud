<!-- <script>
  function initFreshChat() {
    window.fcWidget.init({
      token: "3aef3c88-0274-46b6-9151-bf2c241f1adb",
...
<!-- <script>
  function initFreshChat() {
    window.fcWidget.init({
      token: "68368fb0-0c34-455f-94b8-600358a9442e",
      host: "https://wchat.in.freshchat.com"
    });
  }
  function initialize(i,t){var e;i.getElementById(t)?initFreshChat():((e=i.createElement("script")).id=t,e.async=!0,e.src="https://wchat.in.freshchat.com/js/widget.js",e.onload=initFreshChat,i.head.appendChild(e))}function initiateCall(){initialize(document,"Freshdesk Messaging-js-sdk")}window.addEventListener?window.addEventListener("load",initiateCall,!1):window.attachEvent("load",initiateCall,!1);
</script>
<a href="https://api.whatsapp.com/send?phone=919999999341&text=I'm%20interested%20in%20your%20services" target="_blank">  Click to WhatsApp Chat</a> -->
   <footer>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('input[type=text], select, textarea').keyup(function(){
                ...
                $("#first_name, #middle_name, #sur_name, #customer_name, #special_approval, #bankHolder_name").keypress(function(event){
